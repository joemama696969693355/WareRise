...
local function vapeGithubRequest(scripturl)
	if not isfile(baseDirectory..scripturl) then
		local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/joemama696969693355/WareRewrite/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
		assert(suc, res)

...
local function riseGithubRequest(scripturl)
    print("1", scripturl)
	local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/joemama696969693355/WareRise/main/'..scripturl, true) end)
...
local function downloadFonts()
	...
	local res1 = "https://api.github.com/repos/joemama696969693355/WareRise/contents/fonts"
			...
			if (not shared.VWEXECUTED) then
				...
				if shared.VapeDeveloper or shared.VoidDev then
					if isfile('rise/NewMainScript.lua') then
						...
						shared.RiseMode = true
						loadstring(game:HttpGet("https://raw.githubusercontent.com/joemama696969693355/WareRise/main/NewMainScript.lua", true))()
					end
				else
					shared.RiseMode = true
					loadstring(game:HttpGet("https://raw.githubusercontent.com/joemama696969693355/WareRise/main/NewMainScript.lua", true))()
